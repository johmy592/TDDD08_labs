...
dfs_help(In,Visited,Goal) :-
    not(In=Goal),
    children(In,Child),
    check_visited(Visited,Child),
    append(Visited,[Child],New_Visited),
...
%[[3,3],0,[0,0]]-->[[2,2],1,[1,1]]-->[[3,2],0,[0,1]]-->[[3,0],1,[0,3]]-->[[3,1],0,[0,2]]-->
%[[1,1],1,[2,2]]-->[[2,2],0,[1,1]]-->[[0,2],1,[3,1]]-->[[0,3],0,[3,0]]-->[[0,1],1,[3,2]]-->
%[[1,1],0,[2,2]]-->[[0,0],1,[3,3]]-->[[0,0],1,[3,3]]
%true ;

%[[3,3],0,[0,0]]-->[[2,2],1,[1,1]]-->[[3,2],0,[0,1]]-->[[3,0],1,[0,3]]-->[[3,1],0,[0,2]]-->
%[[1,1],1,[2,2]]-->[[2,2],0,[1,1]]-->[[0,2],1,[3,1]]-->[[0,3],0,[3,0]]-->[[0,1],1,[3,2]]-->
%[[0,2],0,[3,1]]-->[[0,0],1,[3,3]]-->[[0,0],1,[3,3]]
%true ;

%[[3,3],0,[0,0]]-->[[3,1],1,[0,2]]-->[[3,2],0,[0,1]]-->[[3,0],1,[0,3]]-->[[3,1],0,[0,2]]-->
%[[1,1],1,[2,2]]-->[[2,2],0,[1,1]]-->[[0,2],1,[3,1]]-->[[0,3],0,[3,0]]-->[[0,1],1,[3,2]]-->
%[[1,1],0,[2,2]]-->[[0,0],1,[3,3]]-->[[0,0],1,[3,3]]
%true ;
...
% NUMBER OF (NON-LOOPING) SOLUTIONS:
% ?- aggregate_all(count,dfs([[3,3],0,[0,0]],[[0,0],1,[3,3]]),Count).
% Count = 4
% 
% ###########################################################################
...
%[[3,3],0,[0,0]]--->[[2,2],1,[1,1]]--->[[3,1],1,[0,2]]--->[[3,2],1,[0,1]]--->[[3,2],0,[0,1]]--->
%[[3,2],0,[0,1]]--->[[3,0],1,[0,3]]--->[[3,0],1,[0,3]]--->[[3,1],0,[0,2]]--->[[3,1],0,[0,2]]--->
%[[1,1],1,[2,2]]--->[[1,1],1,[2,2]]--->[[2,2],0,[1,1]]--->[[2,2],0,[1,1]]--->[[0,2],1,[3,1]]--->
%[[0,2],1,[3,1]]--->[[0,3],0,[3,0]]--->[[0,3],0,[3,0]]--->[[0,1],1,[3,2]]--->[[0,1],1,[3,2]]--->
%[[1,1],0,[2,2]]--->[[0,2],0,[3,1]]--->[[1,1],0,[2,2]]--->[[0,2],0,[3,1]]--->
%'Found Goal: '[[0,0],1,[3,3]]
